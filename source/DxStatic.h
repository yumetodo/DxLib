...
extern	int			NS_DrawBoxAA(        float x1, float y1, float x2, float y2,                                         unsigned int Color, int FillFlag, float LineThickness = 1.0f ) ;	// 四角形の描画する( アンチエイリアス付き )
...
extern	int			NS_DrawRoundRectAA(  float x1, float y1, float x2, float y2, float rx, float ry,                     unsigned int Color, int FillFlag, float LineThickness = 1.0f ) ;		// 角の丸い四角形を描画する( アンチエイリアス付き )
