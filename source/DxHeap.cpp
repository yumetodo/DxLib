...
extern int AddHeapMemory( HEAPINFO *Heap, void *HeapAddress, ALLOCMEM_SIZE_TYPE HeapSize )
{
	...
	if( HeapAddress == NULL && Heap->AutoAlloc )
	{
		...
		{
			DXST_ERRORLOGFMT_ADDUTF16LE(( "\xd2\x30\xfc\x30\xd7\x30\x28\x75\xe1\x30\xe2\x30\xea\x30\x6e\x30\xba\x78\xdd\x4f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x00"/*@ L"ヒープ用メモリの確保に失敗しました" @*/ )) ;
			DX_HEAP_LEAVE_CRITICAL_SECTION( Heap )
			return -1 ;
		}
