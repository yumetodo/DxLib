...
extern	int			FileRead_scanf_baseCHAR(    STREAMDATA *StreamData, const char  *Format,        va_list Param ) ;	// ファイルから書式化されたデータを読み出す
extern	int			FileRead_scanf_baseUTF16LE( STREAMDATA *StreamData, const WORD  *FormatUTF16LE, va_list Param ) ;	// ファイルから書式化されたデータを読み出す
