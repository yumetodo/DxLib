...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x316d
#define DXLIB_VERSION_STR_T _T("3.16d")
#define DXLIB_VERSION_STR_W   L"3.16d"
...
extern	int			DrawCircleAA(     float x,  float y,  float r,            int posnum,                             unsigned int Color, int FillFlag = TRUE, float LineThickness = 1 ) ;	// 円を描画する( アンチエイリアス付き )
extern	int			DrawOval(         int   x,  int   y,  int   rx, int   ry,                                         unsigned int Color, int FillFlag,        int   LineThickness = 1 ) ;	// 楕円を描画する
extern	int			DrawOvalAA(       float x,  float y,  float rx, float ry, int posnum,                             unsigned int Color, int FillFlag,        float LineThickness = 1 ) ;	// 楕円を描画する( アンチエイリアス付き )
