...
*/
		...
		if( IsMainTarget )
		{
			if( NS_GetWindowModeFlag() == TRUE )
			{
				...
				DXST_ERRORLOGFMT_ADDUTF16LE(( "\x5b\x00\xa6\x30\xa4\x30\xf3\x30\xc9\x30\xa6\x30\xe2\x30\xfc\x30\xc9\x30\x20\x00\x25\x00\x64\x00\x78\x00\x25\x00\x64\x00\x5d\x00\x00"/*@ L"[ウインドウモード %dx%d]" @*/, SwapChainDesc.BufferDesc.Width, SwapChainDesc.BufferDesc.Height )) ;
			}
			else
			{
				...
				DXST_ERRORLOGFMT_ADDUTF16LE(( "\x5b\x00\xd5\x30\xeb\x30\xb9\x30\xaf\x30\xea\x30\xfc\x30\xf3\x30\xe2\x30\xfc\x30\xc9\x30\x20\x00\x25\x00\x64\x00\x78\x00\x25\x00\x64\x00\x5d\x00\x00"/*@ L"[フルスクリーンモード %dx%d]" @*/, SwapChainDesc.BufferDesc.Width, SwapChainDesc.BufferDesc.Height )) ;
			}
		}
		else
		{
...
//	D_ID3D11RenderTargetView		*DrawValidTextureRTV = NULL ;
	...
	*MapTempTexture = NULL ;
		...
		TargetTexture2DDesc.MipLevels        != 1 )
	{
		...
		if( FAILED( hr ) )
		{
			DXST_ERRORLOG_ADDUTF16LE( "\xc0\x30\xa6\x30\xf3\x30\xb5\x30\xf3\x30\xd7\x30\xea\x30\xf3\x30\xb0\x30\x28\x75\xc6\x30\xaf\x30\xb9\x30\xc1\x30\xe3\x30\x6e\x30\x5c\x4f\x10\x62\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ダウンサンプリング用テクスチャの作成に失敗しました\n" @*/ ) ;
			goto ERR ;
		}
...
//		GSYS.HardInfo.TextureSizeNonPow2Conditional = FALSE ;
	...
	// 各種フォーマットを調べる
	{
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x41\x42\x47\x52\x20\x90\xae\x90\x94\x20\x31\x36\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "ABGR 整数 16 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x41\x42\x47\x52\x20\x95\x82\x93\xae\x8f\xac\x90\x94\x93\x5f\x20\x31\x36\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "ABGR 浮動小数点 16 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x41\x42\x47\x52\x20\x95\x82\x93\xae\x8f\xac\x90\x94\x93\x5f\x20\x33\x32\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "ABGR 浮動小数点 32 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x82\x50\x83\x60\x83\x83\x83\x93\x83\x6c\x83\x8b\x90\xae\x90\x94\x20\x38\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "１チャンネル整数 8 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x82\x50\x83\x60\x83\x83\x83\x93\x83\x6c\x83\x8b\x90\xae\x90\x94\x20\x31\x36\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "１チャンネル整数 16 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x82\x50\x83\x60\x83\x83\x83\x93\x83\x6c\x83\x8b\x95\x82\x93\xae\x8f\xac\x90\x94\x93\x5f\x20\x31\x36\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "１チャンネル浮動小数点 16 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x82\x50\x83\x60\x83\x83\x83\x93\x83\x6c\x83\x8b\x95\x82\x93\xae\x8f\xac\x90\x94\x93\x5f\x20\x33\x32\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "１チャンネル浮動小数点 32 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x82\x51\x83\x60\x83\x83\x83\x93\x83\x6c\x83\x8b\x90\xae\x90\x94\x20\x38\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "２チャンネル整数 8 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x82\x51\x83\x60\x83\x83\x83\x93\x83\x6c\x83\x8b\x90\xae\x90\x94\x20\x31\x36\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "２チャンネル整数 16 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x82\x51\x83\x60\x83\x83\x83\x93\x83\x6c\x83\x8b\x95\x82\x93\xae\x8f\xac\x90\x94\x93\x5f\x20\x31\x36\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "２チャンネル浮動小数点 16 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
		...
		{
			DXST_ERRORLOGFMT_ADDA(( "\x82\x51\x83\x60\x83\x83\x83\x93\x83\x6c\x83\x8b\x95\x82\x93\xae\x8f\xac\x90\x94\x93\x5f\x20\x33\x32\x20\x83\x72\x83\x62\x83\x67\x8c\x5e\x83\x4a\x83\x89\x81\x5b\x83\x74\x83\x48\x81\x5b\x83\x7d\x83\x62\x83\x67\x82\xcd\x20\x25\x73\x20\x82\xc5\x82\xb7"/*@ "２チャンネル浮動小数点 32 ビット型カラーフォーマットは %s です" @*/, String )) ;
		}
...
//			Texture2DDesc.CPUAccessFlags     = D_D3D11_CPU_ACCESS_WRITE ;
			...
			if( FAILED( hr ) )
			{
				DXST_ERRORLOG_ADDUTF16LE( "\xde\x30\xeb\x30\xc1\x30\xb5\x30\xf3\x30\xd7\x30\xeb\x30\xc6\x30\xaf\x30\xb9\x30\xc1\x30\xe3\x30\x6e\x30\x5c\x4f\x10\x62\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"マルチサンプルテクスチャの作成に失敗しました\n" @*/ ) ;
				return -1 ;
			}
		}
