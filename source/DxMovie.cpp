...
)
{
...
#endif // DX_NON_OGGTHEORA
	{
		...
		if( FileName == NULL )
		{
			DXST_ERRORLOG_ADDUTF16LE( "\xe0\x30\xfc\x30\xd3\x30\xfc\x30\xd5\x30\xa1\x30\xa4\x30\xeb\x30\xaa\x30\xfc\x30\xd7\x30\xf3\x30\xe6\x51\x06\x74\x42\x66\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x00"/*@ L"ムービーファイルオープン処理時に失敗しました" @*/ ) ;
			goto ERR ;
		}
